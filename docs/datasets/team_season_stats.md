...
NBA Stats Team Season Stats from hoopR data repository — `leaguedashteamstats` (season-level).

| | |
|---|---|
| **Builder** | [`python/nba_stats_03_team_season_stats_creation.py`](../../python/nba_stats_03_team_season_stats_creation.py) |
| **Release tag** | [`nba_stats_team_season_stats`](https://github.com/sportsdataverse/sportsdataverse-data/releases/tag/nba_stats_team_season_stats) |
...
_Coverage is tracked per release asset on [`nba_stats_team_season_stats`](https://github.com/sportsdataverse/sportsdataverse-data/releases/tag/nba_stats_team_season_stats)._
